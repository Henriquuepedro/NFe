            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between flex-wrap">
                    <div class="col-md-6 no-padding">
                        ...
                        <small>Tabela listando todos os clientes cadastrados</small>
                    </div>
                    <div class="col-md-6 text-right no-padding">
                        <a href="{{ route('admin.client.register') }}" class="btn btn-primary col-md-auto col-xs-12">Novo Registro</a>
                    </div>
                </div>
                <!-- /.card-header -->
                                ...
                                <td class="text-center">
                                    <div class="btn-group dropleft">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('admin.client.edit', ['id' => $client['id']]) }}"><i class="fa fa-edit"></i> Alterar Cadastro</a> <br/>
                                            <a href="#" class="text-danger" id-token="{{ $client['idToken'] }}"><i class="fa fa-trash"></i> Excluir Cadastro</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
        ...
        <div class="modal-content">
            {!! Form::open([
                ...
                <div class="modal-body">
                    ...
                    <hr>
                    <h6 class="mt-2 text-center text-blue text-uppercase"><strong class="client"></strong></h6>
                </div>
...
@section('js')
    <script src="{{asset('admin/js/client/index.js')}}"></script>
@stop