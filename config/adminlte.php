...
return [
    ...
    */
    ...
    'logo' => '<b>System</b>NFE', // Edit Pedro
    ...
    */
    ...
    'classes_body' => 'text-sm', // Edit Pedro
    'classes_brand' => 'navbar-teal',
    'classes_brand_text' => '',
    'classes_content_header' => 'container-fluid',
    'classes_content' => 'container-fluid',
    'classes_sidebar' => 'sidebar-dark-teal',
    'classes_sidebar_nav' => 'nav-flat nav-legacy', // Edit Pedro
    ...
    */
    ...
    'dashboard_url' => 'admin/home', // Edit Pedro
    ...
    */
    ...
    |
    | Edit: Pedro Henrique 17/12/2019
    |
    */
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'active'    => ['admin/cliente/listagem', 'admin/cliente/cadastro', 'admin/cliente/editar/*']
                ],
                [
                    'text'      => 'Produtos',
                    'route'     => 'admin.product.list',
                    'active'    => ['admin/produto/listagem', 'admin/produto/cadastro', 'admin/produto/editar/*']
                ],
                [
                    'text'      => 'Natureza',
                    'route'     => 'admin.nature.list',
                    'active'    => ['admin/natureza/listagem', 'admin/natureza/cadastro', 'admin/natureza/editar/*']
                ]
            ],
        ],
        [
            ...
            'submenu' => [
                [
                    ...
                    'route'     => 'admin.sale.list',
                    'active'    => ['admin/venda/listagem', 'admin/venda/cadastro', 'admin/venda/editar/*', 'admin/venda/nfe/*']
                ]
            ],
        ]
    ],
        ...
        [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/select2/4.0.12/js/select2.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/select2/4.0.12/css/select2.css',
                ],
            ],
        ],
        [
        ...
        [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/pace-progress/themes/red/pace-theme-flash.css',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
        ...
        [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/jquery-mask/jquery.mask.js',
                ]
            ],
        ],
        [
