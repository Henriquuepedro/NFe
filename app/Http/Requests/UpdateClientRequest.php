...
class UpdateClientRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'nameComplet'       => 'required|string|min:3|unique:clients,razao_social,' . $this->get('id'),
            'fantasia'          => 'nullable|min:3',
            'documentCpfCnpj'   => 'nullable|cpf_cnpj_update|unique:clients,cnpj_cpf,' . $this->get('id'),
    ...
    public function messages() {
        return [
            ...
            'nameComplet.unique'                => 'O nome do cliente já está em uso!',
            'fantasia.min'                      => 'A fantasia do cliente deve conter no mínimo 3 caracteres!',
            'documentCpfCnpj.cpf_cnpj_update'   => 'Documento de CNPJ/CPF está em um formado inválido!',
            'documentCpfCnpj.unique'            => 'Documento de CNPJ/CPF já está em uso!',
